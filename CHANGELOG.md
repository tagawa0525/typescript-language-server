...
## [7.0.0](https://github.com/tagawa0525/typescript-language-server/compare/v6.0.1...v7.0.0) (2026-09-25)


### ⚠ BREAKING CHANGES

* Node.js >=22.22.2 is required.
* require at least node 20 ([#994](https://github.com/tagawa0525/typescript-language-server/issues/994))
* require node 18+
...
* **deps:** update LSP libraries to match 3.17 spec ([#532](https://github.com/tagawa0525/typescript-language-server/issues/532)) ([bdbdd83](https://github.com/tagawa0525/typescript-language-server/commit/bdbdd8379815583aa28d2a770034253050ba24de))
* migrate from yarn to pnpm ([#1096](https://github.com/tagawa0525/typescript-language-server/issues/1096)) ([7e792e6](https://github.com/tagawa0525/typescript-language-server/commit/7e792e6942aa3bf12af9d560cbb44cbe24bc3698))


### Features

* `source.removeUnusedImports.ts` and `source.sortImports.ts` actions ([#681](https://github.com/tagawa0525/typescript-language-server/issues/681)) ([a43b2df](https://github.com/tagawa0525/typescript-language-server/commit/a43b2df471572ca2e25b12899f65fca77853af35))
* add "Go To Source Definition" command ([#560](https://github.com/tagawa0525/typescript-language-server/issues/560)) ([9bcdaf2](https://github.com/tagawa0525/typescript-language-server/commit/9bcdaf2b0b09da9aa4d7e6ed79bdcd742b3cfc17))
* add `_typescript.configurePlugin` workspace command ([#607](https://github.com/tagawa0525/typescript-language-server/issues/607)) ([59a5217](https://github.com/tagawa0525/typescript-language-server/commit/59a52174148f3dc95fa2969971a1f95c6e432812))
* add `tsserver.logDirectory` to `initializationOptions` ([#588](https://github.com/tagawa0525/typescript-language-server/issues/588)) ([114d430](https://github.com/tagawa0525/typescript-language-server/commit/114d4309cb1450585f991604118d3eff3690237c))
* add `tsserver.logVerbosity` and `tsserver.path` to `initializationOptions` ([#611](https://github.com/tagawa0525/typescript-language-server/issues/611)) ([a03eab5](https://github.com/tagawa0525/typescript-language-server/commit/a03eab5f1442ad68745d6bec464191a66ab85fc7))
* add `tsserver.trace` init option for tracing tsserver ([#586](https://github.com/tagawa0525/typescript-language-server/issues/586)) ([e3e8930](https://github.com/tagawa0525/typescript-language-server/commit/e3e893094e501e3d6a72148e05f11286d688d2bd))
* Add insert replace support for completions ([#583](https://github.com/tagawa0525/typescript-language-server/issues/583)) ([fdf9d11](https://github.com/tagawa0525/typescript-language-server/commit/fdf9d11200c49a160ed3c3bd523e4792bc98e99d))
* add opt-in eager diagnostic clearing on didChange ([#1064](https://github.com/tagawa0525/typescript-language-server/issues/1064)) ([d3acbf4](https://github.com/tagawa0525/typescript-language-server/commit/d3acbf4bb850837c20ce8f10744f8188aea4f1c6))
* add support for `[@link](https://github.com/link)` references in JSDoc ([#612](https://github.com/tagawa0525/typescript-language-server/issues/612)) ([3722b51](https://github.com/tagawa0525/typescript-language-server/commit/3722b51c0ad8e758c4e42f622bbe25ae981071e1))
* Add support for client-side file watcher ([#1057](https://github.com/tagawa0525/typescript-language-server/issues/1057)) ([b962129](https://github.com/tagawa0525/typescript-language-server/commit/b9621294c0006e6076c984e98a5db31e6b8dd8c2))
* add support for CompletionItem.labelDetails ([#534](https://github.com/tagawa0525/typescript-language-server/issues/534)) ([3c140d9](https://github.com/tagawa0525/typescript-language-server/commit/3c140d958507300d7d186adb84f5b0baa549edb2))
* add support for locale option ([#461](https://github.com/tagawa0525/typescript-language-server/issues/461)) ([be6a95d](https://github.com/tagawa0525/typescript-language-server/commit/be6a95ddf6abf8cb68689a6995e3e55858eacb23))
* add support for new features from TypeScript 4.8 ([#576](https://github.com/tagawa0525/typescript-language-server/issues/576)) ([7e88db3](https://github.com/tagawa0525/typescript-language-server/commit/7e88db301a56d6d2dcd0fc1872d6baa386210497))
* add support for rename prefixText and suffixText on rename ([#478](https://github.com/tagawa0525/typescript-language-server/issues/478)) ([b3c8535](https://github.com/tagawa0525/typescript-language-server/commit/b3c85354c71dc36e1d4775bf61d7064a6b85e958))
* add support for textDocument/linkedEditingRange ([#732](https://github.com/tagawa0525/typescript-language-server/issues/732)) ([983a692](https://github.com/tagawa0525/typescript-language-server/commit/983a6923114c39d638e0c7d419ae16e8bca8985c))
* add support for typescript.tsserverRequest command ([#967](https://github.com/tagawa0525/typescript-language-server/issues/967)) ([f09e87a](https://github.com/tagawa0525/typescript-language-server/commit/f09e87a8d7bca95db3487d115c869612463796dc)), closes [#959](https://github.com/tagawa0525/typescript-language-server/issues/959)
* add tsserver.fallbackPath to initialization options ([#831](https://github.com/tagawa0525/typescript-language-server/issues/831)) ([9253dd8](https://github.com/tagawa0525/typescript-language-server/commit/9253dd8eb9ba8b0d8dcfb5fbe1533e7609c040d4))
* add workspace implicit project defaults configuration ([#605](https://github.com/tagawa0525/typescript-language-server/issues/605)) ([c6b3947](https://github.com/tagawa0525/typescript-language-server/commit/c6b39473ed5343f99434506ee034fd0d45a5364d))
* communicate with tsserver &gt;=4.9.0 using IPC ([#630](https://github.com/tagawa0525/typescript-language-server/issues/630)) ([06abfde](https://github.com/tagawa0525/typescript-language-server/commit/06abfdeb133127f4567efb77a2bf725549e9d957))
* drop experimental `textDocument/calls`, `typescript/inlayHints` ([#647](https://github.com/tagawa0525/typescript-language-server/issues/647)) ([b15f8a7](https://github.com/tagawa0525/typescript-language-server/commit/b15f8a7cca8470b0ef9e9878e94fba95e278d372))
* hover info verbosity ([#1092](https://github.com/tagawa0525/typescript-language-server/issues/1092)) ([b73207c](https://github.com/tagawa0525/typescript-language-server/commit/b73207c610912dd278cf64733a0c5c7ce26b3a58))
* implement `textDocument/selectionRange` request ([#642](https://github.com/tagawa0525/typescript-language-server/issues/642)) ([a5598c6](https://github.com/tagawa0525/typescript-language-server/commit/a5598c68aac961cbd6294133a9235e4db5b95929))
* implement support for spec version of Call Hierarchy ([#649](https://github.com/tagawa0525/typescript-language-server/issues/649)) ([3ce0e17](https://github.com/tagawa0525/typescript-language-server/commit/3ce0e17e72f32913739c9d67d3dfb6092f09a2aa))
* include "triggerReason" and "kind" in code action requests ([#579](https://github.com/tagawa0525/typescript-language-server/issues/579)) ([f872078](https://github.com/tagawa0525/typescript-language-server/commit/f872078fa3b40d8b9b90f737fec7a4c808f1ccc7))
* opt-in support for the "Move to file" interactive code action ([#987](https://github.com/tagawa0525/typescript-language-server/issues/987)) ([6cf230c](https://github.com/tagawa0525/typescript-language-server/commit/6cf230c4b357af0543f183b168b841a836b6e7bc))
* provide filterText property in completions ([#678](https://github.com/tagawa0525/typescript-language-server/issues/678)) ([af44f8b](https://github.com/tagawa0525/typescript-language-server/commit/af44f8b1b5a252ca9ba019691ad81dc2e5006468))
* refresh inlay hints and code lens on relevant configuration change ([#1095](https://github.com/tagawa0525/typescript-language-server/issues/1095)) ([fd53d0e](https://github.com/tagawa0525/typescript-language-server/commit/fd53d0e5948f84c12fa8a90b512cad9b2a604fce))
* request file-specific formatting options ([#1034](https://github.com/tagawa0525/typescript-language-server/issues/1034)) ([de89dd3](https://github.com/tagawa0525/typescript-language-server/commit/de89dd34b27d9dd65b9c3823ad2ddae06eb73c47))
* send `$/typescriptVersion` notification with TypeScript version ([#674](https://github.com/tagawa0525/typescript-language-server/issues/674)) ([b081112](https://github.com/tagawa0525/typescript-language-server/commit/b081112f12a35fa70aae3a134191dea025de64da))
* start separate tsServer instance for semantic requests ([#688](https://github.com/tagawa0525/typescript-language-server/issues/688)) ([fa65b84](https://github.com/tagawa0525/typescript-language-server/commit/fa65b847f4a87672cc28302f38fd86e8f56d6112))
* support `textDocument/inlayHint` request from 3.17.0 spec ([#566](https://github.com/tagawa0525/typescript-language-server/issues/566)) ([9a2fd4e](https://github.com/tagawa0525/typescript-language-server/commit/9a2fd4e34b6c50c57b974f617018dcefdb469788))
* support `textDocument/prepareRename` request ([#628](https://github.com/tagawa0525/typescript-language-server/issues/628)) ([9c66794](https://github.com/tagawa0525/typescript-language-server/commit/9c6679438d6190b72a15f32c0eb83cacd7780213))
* support `workspace/willRenameFiles` request ([#685](https://github.com/tagawa0525/typescript-language-server/issues/685)) ([c3f3529](https://github.com/tagawa0525/typescript-language-server/commit/c3f3529be45a1630fe7903a5af9e732855f2c664))
* support code lens for references and implementations ([#785](https://github.com/tagawa0525/typescript-language-server/issues/785)) ([ae058c2](https://github.com/tagawa0525/typescript-language-server/commit/ae058c22a4900913e9516c0e3c0c46bbd741760c))
* support communicating with tsserver using IPC ([#585](https://github.com/tagawa0525/typescript-language-server/issues/585)) ([8725b9b](https://github.com/tagawa0525/typescript-language-server/commit/8725b9bee4432b7520ebd9adc67f4c65303b2c8c))
* support for canceling LSP requests ([#672](https://github.com/tagawa0525/typescript-language-server/issues/672)) ([1daf209](https://github.com/tagawa0525/typescript-language-server/commit/1daf209121fc20bbc0a64ec0491cd40582cb9a4b))
* support for codeAction disabledSupport client capability ([#578](https://github.com/tagawa0525/typescript-language-server/issues/578)) ([f93b849](https://github.com/tagawa0525/typescript-language-server/commit/f93b8493eeafda32c865c93e99025c8ca11c3226))
* support LocationLink[] for textDocument/definition response ([#563](https://github.com/tagawa0525/typescript-language-server/issues/563)) ([196f328](https://github.com/tagawa0525/typescript-language-server/commit/196f328cd9fd7a06998151d59bed0b945cc68b40))
* support passing "mode" to organize imports command ([#1036](https://github.com/tagawa0525/typescript-language-server/issues/1036)) ([a7c24b8](https://github.com/tagawa0525/typescript-language-server/commit/a7c24b85a4503f320aa78fb12ea6cb3f81186b28))
* support specifying language IDs in plugins ([#834](https://github.com/tagawa0525/typescript-language-server/issues/834)) ([e9c0b11](https://github.com/tagawa0525/typescript-language-server/commit/e9c0b117a9a5e273eb517dc0d337ecdf973f3dac))
* update implicit project defaults ([#1077](https://github.com/tagawa0525/typescript-language-server/issues/1077)) ([7ff6ede](https://github.com/tagawa0525/typescript-language-server/commit/7ff6edea01f1d7e07b5906f4da07086fe9bc6ddb))
* update typescript to 4.9.3 ([#629](https://github.com/tagawa0525/typescript-language-server/issues/629)) ([0005648](https://github.com/tagawa0525/typescript-language-server/commit/00056483da3f1089a3a426f08bc66651178c3665))


### Bug Fixes

* add folder filter in server capabilities for `willRename` ([#814](https://github.com/tagawa0525/typescript-language-server/issues/814)) ([fe3d21b](https://github.com/tagawa0525/typescript-language-server/commit/fe3d21b159dfa0204da7f94aac04459b1bd4ea88))
* add more logging for resolving user-specified tsserver ([#412](https://github.com/tagawa0525/typescript-language-server/issues/412)) ([7139a32](https://github.com/tagawa0525/typescript-language-server/commit/7139a32da05b6e3dfcd3252bde934dc499412d3d))
* align completions code with upstream ([#992](https://github.com/tagawa0525/typescript-language-server/issues/992)) ([f0eb0f5](https://github.com/tagawa0525/typescript-language-server/commit/f0eb0f5abb981cbf496d5fc9e2b2e49150437c12))
* announce all supported commands ([#1053](https://github.com/tagawa0525/typescript-language-server/issues/1053)) ([e9fe952](https://github.com/tagawa0525/typescript-language-server/commit/e9fe952baee4030aad6fbc24fb55bf2b84ad98e8))
* apply refactoring returns -1 positions in ranges ([#502](https://github.com/tagawa0525/typescript-language-server/issues/502)) ([5f52db0](https://github.com/tagawa0525/typescript-language-server/commit/5f52db0383d6c326cd321c13fc969ab9d3958011))
* avoid sending window/workDoneProgress/create before init ([#846](https://github.com/tagawa0525/typescript-language-server/issues/846)) ([625048f](https://github.com/tagawa0525/typescript-language-server/commit/625048fac8533bccdeda82ee140d4f7792d9fb04))
* avoid triggering unhandled exception when tsserver crashes ([#805](https://github.com/tagawa0525/typescript-language-server/issues/805)) ([d537b08](https://github.com/tagawa0525/typescript-language-server/commit/d537b08597d3d1b4e5b78e0e39bf0ba22f9a9dd1))
* call configure before completion resolve ([#377](https://github.com/tagawa0525/typescript-language-server/issues/377)) ([a3c3af4](https://github.com/tagawa0525/typescript-language-server/commit/a3c3af4c2561b114e9418be9ceb5513b4e01e676))
* cancel pending geterr request before triggering new ([#651](https://github.com/tagawa0525/typescript-language-server/issues/651)) ([95b92e5](https://github.com/tagawa0525/typescript-language-server/commit/95b92e5d15f47eea77e08765a1e378dbcd90d1f0))
* code actions handling ([#1009](https://github.com/tagawa0525/typescript-language-server/issues/1009)) ([fd53ca8](https://github.com/tagawa0525/typescript-language-server/commit/fd53ca82a7ad74ab6c6fd6102ccf64d0a73a54bd)), closes [#954](https://github.com/tagawa0525/typescript-language-server/issues/954)
* completion for strings with trigger character ([#492](https://github.com/tagawa0525/typescript-language-server/issues/492)) ([76bf9a4](https://github.com/tagawa0525/typescript-language-server/commit/76bf9a4817ffa1e340422cfd5177dbcb96528ddb))
* **completions:** don't create snippet kind without `completeFunctionCalls` ([#595](https://github.com/tagawa0525/typescript-language-server/issues/595)) ([7f69c27](https://github.com/tagawa0525/typescript-language-server/commit/7f69c27eb8cce71d3db006623757a74f93d76dd3))
* **completions:** don't insert call snippet if already a call ([#646](https://github.com/tagawa0525/typescript-language-server/issues/646)) ([5d34de5](https://github.com/tagawa0525/typescript-language-server/commit/5d34de5fd38ce5a9dcafc4a385ccb39b0a89f2b0))
* **completions:** don't set `filterText` after all ([#686](https://github.com/tagawa0525/typescript-language-server/issues/686)) ([4c5d295](https://github.com/tagawa0525/typescript-language-server/commit/4c5d295d4f71f6b5d8f2c58e908d5cc79cb9e3d2))
* **completions:** don't set commitCharacters unless client supports those ([#684](https://github.com/tagawa0525/typescript-language-server/issues/684)) ([af10a97](https://github.com/tagawa0525/typescript-language-server/commit/af10a977f38626797dbadca935c71f92556fdb39))
* **completions:** include `filterText` property by default ([#693](https://github.com/tagawa0525/typescript-language-server/issues/693)) ([c07426a](https://github.com/tagawa0525/typescript-language-server/commit/c07426adc8b079273c267e18d11993d53d482886))
* **completions:** remove filterText override for bracket accessor ([#593](https://github.com/tagawa0525/typescript-language-server/issues/593)) ([1ed4e2e](https://github.com/tagawa0525/typescript-language-server/commit/1ed4e2eccf0b52e10204b5c2617d4944ae513afd))
* crash on empty response from typescript.tsserverRequest ([#1118](https://github.com/tagawa0525/typescript-language-server/issues/1118)) ([116f745](https://github.com/tagawa0525/typescript-language-server/commit/116f745e277185a133557870c78e11c5a7e2e9fe))
* declare quickfix/refactor CodeAction capabilities ([#553](https://github.com/tagawa0525/typescript-language-server/issues/553)) ([e76fc64](https://github.com/tagawa0525/typescript-language-server/commit/e76fc6493295649d6ada83c8a5f6d88abe2a6167))
* definition request crashing on getting span ([#574](https://github.com/tagawa0525/typescript-language-server/issues/574)) ([4e1c82b](https://github.com/tagawa0525/typescript-language-server/commit/4e1c82b82878316a12ff6b524d7dd5ab54b86acd))
* **deps:** update devdependency typescript to ^4.9.4 ([#637](https://github.com/tagawa0525/typescript-language-server/issues/637)) ([d2b18b6](https://github.com/tagawa0525/typescript-language-server/commit/d2b18b6d318c4b441e42f4f977ba6bd4eca36d58))
* **deps:** update devdependency typescript to ^4.9.5 ([#677](https://github.com/tagawa0525/typescript-language-server/issues/677)) ([916c326](https://github.com/tagawa0525/typescript-language-server/commit/916c326d576b9f13a05563495dffa27b4d02ee6e))
* **deps:** update devdependency typescript to ^5.1.3 ([#727](https://github.com/tagawa0525/typescript-language-server/issues/727)) ([af477a2](https://github.com/tagawa0525/typescript-language-server/commit/af477a2acacced85b52ca1fdb967f17228496c30))
* **deps:** update devdependency typescript to ^5.2.2 ([#737](https://github.com/tagawa0525/typescript-language-server/issues/737)) ([0fff121](https://github.com/tagawa0525/typescript-language-server/commit/0fff121490f255c42c4f78d6c3cdb7d37668cbed))
* **deps:** update devdependency typescript to ^5.3.2 ([#820](https://github.com/tagawa0525/typescript-language-server/issues/820)) ([5eeb20c](https://github.com/tagawa0525/typescript-language-server/commit/5eeb20c78b676c527c3b558bfbaa60e4de1db83f))
* **deps:** update devdependency typescript to ^5.3.3 ([#832](https://github.com/tagawa0525/typescript-language-server/issues/832)) ([9e1744c](https://github.com/tagawa0525/typescript-language-server/commit/9e1744c1dea0493ce76b8cce8a55e2d514b9250b))
* **deps:** update devdependency typescript to ^5.9.2 ([#882](https://github.com/tagawa0525/typescript-language-server/issues/882)) ([93cc29d](https://github.com/tagawa0525/typescript-language-server/commit/93cc29d247441fdb0b86b6bf35aaf22657983a74))
* **deps:** update devdependency typescript to ^5.9.3 ([#1017](https://github.com/tagawa0525/typescript-language-server/issues/1017)) ([44f8778](https://github.com/tagawa0525/typescript-language-server/commit/44f87786a49b9810ac975973fbb5bdeebcdde022))
* disable IPC communication until TypeScript bug is fixed ([#600](https://github.com/tagawa0525/typescript-language-server/issues/600)) ([a6153a6](https://github.com/tagawa0525/typescript-language-server/commit/a6153a66e88bed52704761f92dd4168605ef9a45))
* don't filter out 'warning' TS completion kinds ([ab388a0](https://github.com/tagawa0525/typescript-language-server/commit/ab388a010cbe8353af6c17964e9e2567fa73cce0))
* don't override formatting options with undefined values ([#1041](https://github.com/tagawa0525/typescript-language-server/issues/1041)) ([4645124](https://github.com/tagawa0525/typescript-language-server/commit/464512454a1f68bb6f1e270cf5c0c2be13cdaa54))
* don't report InternalError on tsserver error response ([#709](https://github.com/tagawa0525/typescript-language-server/issues/709)) ([3e63165](https://github.com/tagawa0525/typescript-language-server/commit/3e6316546eb5c8b6fd2fb8c26c88b7b6a6331472))
* don't send duplicate refactors when more than one context.only ([#1055](https://github.com/tagawa0525/typescript-language-server/issues/1055)) ([6ca045a](https://github.com/tagawa0525/typescript-language-server/commit/6ca045aede0931180077c43daa14d586bdccc38f))
* don't transform Yarn zipfile URIs ([#384](https://github.com/tagawa0525/typescript-language-server/issues/384)) ([9d451ea](https://github.com/tagawa0525/typescript-language-server/commit/9d451eaceea71693ad1e262b866218ac7ef60325))
* don't transform zipfile URIs from Vim ([#386](https://github.com/tagawa0525/typescript-language-server/issues/386)) ([2f5a8d9](https://github.com/tagawa0525/typescript-language-server/commit/2f5a8d93372b92ac1102d0a3199719dd72e7eb2c))
* don't trigger error on empty Source Definition response ([#568](https://github.com/tagawa0525/typescript-language-server/issues/568)) ([146a6ba](https://github.com/tagawa0525/typescript-language-server/commit/146a6ba97f0792701ff8afcc431d3a1dfdb978a6))
* don't use the postinstall script ([#364](https://github.com/tagawa0525/typescript-language-server/issues/364)) ([0178e9c](https://github.com/tagawa0525/typescript-language-server/commit/0178e9cce330633b77bc52869cad63cd1dba19b2))
* formatting fails to provide edit at the end of the document ([#718](https://github.com/tagawa0525/typescript-language-server/issues/718)) ([01e24a2](https://github.com/tagawa0525/typescript-language-server/commit/01e24a2cba1b0faf9c65474449265b944e64abd6))
* handle shutdown lifecycle properly ([#536](https://github.com/tagawa0525/typescript-language-server/issues/536)) ([ac8536b](https://github.com/tagawa0525/typescript-language-server/commit/ac8536bf8eb805bfc28e484a8f4827b5375d6824))
* help users resolve no valid tsserver version error ([#337](https://github.com/tagawa0525/typescript-language-server/issues/337)) ([d835543](https://github.com/tagawa0525/typescript-language-server/commit/d835543e455a51ec159457a1479a550712574099))
* improve code actions support ([#1018](https://github.com/tagawa0525/typescript-language-server/issues/1018)) ([8591c0a](https://github.com/tagawa0525/typescript-language-server/commit/8591c0a9e539b8de2340f6c9bf258db6f6eeea3e))
* line offset off by one when at the last line ([#683](https://github.com/tagawa0525/typescript-language-server/issues/683)) ([0db9a5f](https://github.com/tagawa0525/typescript-language-server/commit/0db9a5faa4bc03560506ffd030e795a35e45e3f8))
* loading progress sometimes getting stuck ([#603](https://github.com/tagawa0525/typescript-language-server/issues/603)) ([8cf4381](https://github.com/tagawa0525/typescript-language-server/commit/8cf43810e0ff7a32d3499afc6da2344939b2d6de))
* make wording in the typescript lookup error more generic ([585a05e](https://github.com/tagawa0525/typescript-language-server/commit/585a05e43a0b530f10e488aed634fac0436109ae)), closes [#554](https://github.com/tagawa0525/typescript-language-server/issues/554)
* move deepmerge to dependencies ([06109d4](https://github.com/tagawa0525/typescript-language-server/commit/06109d4646d94bdf1bbeb2768e18f1323ae1b630))
* notify when typescript with no tsserver API found ([#1120](https://github.com/tagawa0525/typescript-language-server/issues/1120)) ([bf088c9](https://github.com/tagawa0525/typescript-language-server/commit/bf088c96d0372964754a849f687ca1c90321d1d2))
* only use optionalReplacementSpan if client supports InsertReplace ([#584](https://github.com/tagawa0525/typescript-language-server/issues/584)) ([899ba6b](https://github.com/tagawa0525/typescript-language-server/commit/899ba6b5c5f13faac8eec6478ced4d9f8d90836d))
* out of date diagnostics after closing and re-opening a file ([#851](https://github.com/tagawa0525/typescript-language-server/issues/851)) ([f395cd6](https://github.com/tagawa0525/typescript-language-server/commit/f395cd67fc0fefb06e301eecb3b0af492c6672da))
* pass format options for organizing import ([#348](https://github.com/tagawa0525/typescript-language-server/issues/348)) ([28feb26](https://github.com/tagawa0525/typescript-language-server/commit/28feb26e95e1a987af719a4e4e4cfbc8fc9bba5d))
* **perf:** cache completion data on the server to avoid serialization ([#768](https://github.com/tagawa0525/typescript-language-server/issues/768)) ([d7b4c77](https://github.com/tagawa0525/typescript-language-server/commit/d7b4c77b6d71e81210623d17a80c0838681de3ca))
* pin old version of LSP libraries for node &lt;14 compatibility ([#467](https://github.com/tagawa0525/typescript-language-server/issues/467)) ([55600e1](https://github.com/tagawa0525/typescript-language-server/commit/55600e12635c01d5a531b776b33d10f9e622a7a6))
* **previewer:** mark `[@example](https://github.com/example)` and `[@default](https://github.com/default)` code blocks as TS ([#918](https://github.com/tagawa0525/typescript-language-server/issues/918)) ([184c60d](https://github.com/tagawa0525/typescript-language-server/commit/184c60de3308621380469d6632bdff2e10f672fd))
* remove hard dependency on typescript ([#661](https://github.com/tagawa0525/typescript-language-server/issues/661)) ([9a2e2c8](https://github.com/tagawa0525/typescript-language-server/commit/9a2e2c83d4992cd90cebc706618a9af604fcf1a9))
* require at least node 20 ([#994](https://github.com/tagawa0525/typescript-language-server/issues/994)) ([63e287d](https://github.com/tagawa0525/typescript-language-server/commit/63e287d81f83c76b46a23733b7fc8df7b082f7aa))
* respect user-provided tsserver.js path from `--tsserver-path` ([#610](https://github.com/tagawa0525/typescript-language-server/issues/610)) ([417339f](https://github.com/tagawa0525/typescript-language-server/commit/417339fa66bc1910c80888c3f909e3d059da8ee5))
* restore handling of zipfile: schema for neovim + yarn berry ([#862](https://github.com/tagawa0525/typescript-language-server/issues/862)) ([caca007](https://github.com/tagawa0525/typescript-language-server/commit/caca0071095557ecc43d8695d922a4cf5e38a2ad))
* restore tsserver version logging on initialization ([#669](https://github.com/tagawa0525/typescript-language-server/issues/669)) ([232219c](https://github.com/tagawa0525/typescript-language-server/commit/232219cd0fe138558ed98e22aa7314e0941e4f10))
* revert to `Node` value for `moduleResolution` in implicit config ([#804](https://github.com/tagawa0525/typescript-language-server/issues/804)) ([97c1794](https://github.com/tagawa0525/typescript-language-server/commit/97c1794be311a2b327f07801119c76d616802ab5))
* snippet completions returned to clients that don't support them ([#556](https://github.com/tagawa0525/typescript-language-server/issues/556)) ([050d335](https://github.com/tagawa0525/typescript-language-server/commit/050d3350e16fe78b7c60d7443ed3ad6d2cc4730d))
* stop the server on syntax server crash ([#1132](https://github.com/tagawa0525/typescript-language-server/issues/1132)) ([a024366](https://github.com/tagawa0525/typescript-language-server/commit/a0243665a84b0d565143ad860d1dfca6e7b17714))
* stop the server when tsserver is killed by a signal ([#1125](https://github.com/tagawa0525/typescript-language-server/issues/1125)) ([db557ce](https://github.com/tagawa0525/typescript-language-server/commit/db557cee861cb5b6d27e6a024d2254f23f2e9308))
* surface stderr output from the tsserver process ([#624](https://github.com/tagawa0525/typescript-language-server/issues/624)) ([adf2689](https://github.com/tagawa0525/typescript-language-server/commit/adf268927a2f4b5e689572be9bedc349573aadd5))
* try to infer languageId from extension when invalid provided ([#799](https://github.com/tagawa0525/typescript-language-server/issues/799)) ([994186e](https://github.com/tagawa0525/typescript-language-server/commit/994186e629494545f855d0859f5a058529e64c95))
* update signature help feature to v3.15.0 LSP spec ([#555](https://github.com/tagawa0525/typescript-language-server/issues/555)) ([da074a6](https://github.com/tagawa0525/typescript-language-server/commit/da074a618ca6c29819834a0344682094d6ff08f6))
* use correct name for the addMissingImports code action ([#371](https://github.com/tagawa0525/typescript-language-server/issues/371)) ([5e31236](https://github.com/tagawa0525/typescript-language-server/commit/5e3123666c5f2d1810125bd1cd40f1e93f3ad912))
* use snippet type for jsx attribute completions ([#362](https://github.com/tagawa0525/typescript-language-server/issues/362)) ([989d92d](https://github.com/tagawa0525/typescript-language-server/commit/989d92d8a931600582266ff772442d7acf7f802b))
* verbosity of the "Using Typescript version" message ([#716](https://github.com/tagawa0525/typescript-language-server/issues/716)) ([448d3f1](https://github.com/tagawa0525/typescript-language-server/commit/448d3f15d881e2594e1e60f71539b3a5d7e9fce2))
* wait for tsserver configuration requests to finish ([#372](https://github.com/tagawa0525/typescript-language-server/issues/372)) ([51673f2](https://github.com/tagawa0525/typescript-language-server/commit/51673f2d91db9039b5c8db956387b25bd3271728))
* wrong import completion when insert/replace supported ([#592](https://github.com/tagawa0525/typescript-language-server/issues/592)) ([4fe902a](https://github.com/tagawa0525/typescript-language-server/commit/4fe902a9e28ec4c3ccc14a9e75488efeb8079544))


### Refactors

* await configuration requests on inline hint request ([25584e5](https://github.com/tagawa0525/typescript-language-server/commit/25584e593b41b598bf9cc169e2a07bfccdfc74da))
* bundle with rollup and switch to jest for testing ([#663](https://github.com/tagawa0525/typescript-language-server/issues/663)) ([2c9eb63](https://github.com/tagawa0525/typescript-language-server/commit/2c9eb632659a3bb9995095576afe88e84833bbdd))
* cache file formatting configuration requests ([#1048](https://github.com/tagawa0525/typescript-language-server/issues/1048)) ([9a366df](https://github.com/tagawa0525/typescript-language-server/commit/9a366dfc7a989829f4b9e53017c298b565a307fd))
* create ConfigurationManager for handling configuration ([#564](https://github.com/tagawa0525/typescript-language-server/issues/564)) ([aac2d16](https://github.com/tagawa0525/typescript-language-server/commit/aac2d16416a7af5d67b496a1e0badcaee4b9e42a))
* don't log when ts client exits with missing or 0 exit code ([507db40](https://github.com/tagawa0525/typescript-language-server/commit/507db40c6c40102868f85af3e1bcaad3b9ae84f4))
* enable strict mode for typescript ([#562](https://github.com/tagawa0525/typescript-language-server/issues/562)) ([7c0ad9f](https://github.com/tagawa0525/typescript-language-server/commit/7c0ad9f253ecefc5a9e61c9e58d1dabc6bcbac57))
* logger implementation ([#590](https://github.com/tagawa0525/typescript-language-server/issues/590)) ([4d0db33](https://github.com/tagawa0525/typescript-language-server/commit/4d0db3375dcda5b49108be4b2cbeb781f80eaf3e))
* move versionProvider to tsServer directory ([0960a6b](https://github.com/tagawa0525/typescript-language-server/commit/0960a6bb2bc02f71a61211d4932fdda524d59ef9))
* pass ITypeScriptServiceClient around instead of TsClient ([e91bd52](https://github.com/tagawa0525/typescript-language-server/commit/e91bd52a47c05ffd946e0abd27f242eb631b7604))
* port ITypeScriptServiceClient ([#782](https://github.com/tagawa0525/typescript-language-server/issues/782)) ([ab22e52](https://github.com/tagawa0525/typescript-language-server/commit/ab22e521615a455026625bad179298087149ccb4))
* remove deprecated CLI options ([#790](https://github.com/tagawa0525/typescript-language-server/issues/790)) ([cadf374](https://github.com/tagawa0525/typescript-language-server/commit/cadf3748a8e0de7655260ddeb1ffb30888723aaf))
* remove some code repetition in request definitions ([e3d6cd7](https://github.com/tagawa0525/typescript-language-server/commit/e3d6cd751f59c4f024f6705790ee734eed472079))
* remove unnecessary "configure" request ([#1043](https://github.com/tagawa0525/typescript-language-server/issues/1043)) ([9db45fd](https://github.com/tagawa0525/typescript-language-server/commit/9db45fd7d21b34057872f0e6eb5f04a1495ead10))
* require node 18+ ([1df5a28](https://github.com/tagawa0525/typescript-language-server/commit/1df5a283e3803e6f2e60579dff0fd4289543b2b2))
* ship as an ES module ([#547](https://github.com/tagawa0525/typescript-language-server/issues/547)) ([0dfd411](https://github.com/tagawa0525/typescript-language-server/commit/0dfd41125c04868b547a3893334bb0bb822e0517))
* use lsp lib helper methods ([#561](https://github.com/tagawa0525/typescript-language-server/issues/561)) ([e8c262d](https://github.com/tagawa0525/typescript-language-server/commit/e8c262d906599f65ec867eae4d8bf7bf8e5886b0))
